            ...
            public void onClick(View view) {
                if(editText.getText().toString()!=null){
                    ...
                    if (nbFace >= 1 && nbFace <= 6) {
                        ...
                        Toast toast=Toast.makeText(MainActivity.this,"nombre incorrecte",Toast.LENGTH_LONG);
                        toast.show();
                        editText.setText("");
                    }
                }
                else{
                    Toast toast=Toast.makeText(MainActivity.this,"chose a number",Toast.LENGTH_LONG);
                    toast.show();
                }
            }
        });
